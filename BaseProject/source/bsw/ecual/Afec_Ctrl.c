...
void AFEC_Init(void){
  ...
  /*AFEC_MR_TRGSEL_AFEC_TRIG1-->TIOA del TMC0 haga el Trigger
    AFEC_MR_TRGEN_EN -->Trigger por hardware  
  */
  ...
  AFEC_SetAnalogOffset(AFEC0, TEST_CHANNEL, CHANNEL_OFFSET); //offset recomendado por el application notes
  AFEC_SetExtModeReg(AFEC0,0| AFEC_EMR_RES(256)| AFEC_EMR_TAG |AFEC_EMR_STM ); //tambien recomendado por el application notes
          
	//Se activan interrupciones para probar si TIOA activa el ADC		                          
